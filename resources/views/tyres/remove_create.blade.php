{{-- MODAL REMOVE CREATE --}}
<div class="modal fade" id="tyre_remove">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
        <h4 class="modal-title"> Remove Tyre</h4>
        ...
        <input type="hidden" name="form_type" value="show_tyre_remove">
        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="text" name="unit_no" value="{{ $last_transaction ? $last_transaction->unit_no : null }}" id="unit_no" class="form-control @error('unit_no') is-invalid @enderror" readonly>
                    @error('unit_no')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="text" name="position" value="{{ $last_transaction ? $last_transaction->position : null }}" id="position" class="form-control @error('position') is-invalid @enderror" readonly>
                    @error('position')
                    <div class="invalid-feedback">
                    {{ $message }}
                    </div>
