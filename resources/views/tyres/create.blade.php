                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="prod_year" id="prod_year" value="{{ old('prod_year') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="otd" id="otd" value="{{ old('otd') }}"
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pressure" id="pressure" value="{{ old('pressure') }}"
                                    ...
                                    <select id="current_project" name="current_project"
                                        ...
                                        @foreach ($projects as $project)
                                            <option value="{{ $project['project_code'] }}"
                                                {{ $project['project_code'] === old('current_project') ? 'selected' : '' }}>
        ...
        $(document).ready(function() {
            ...
            @if (session('success'))
                Swal.fire({
                    ...
                    // Optional: redirect to the search page after showing the message
                    window.location.href = '{{ route('tyres.index', ['page' => 'new']) }}';
                });
            @endif
        });
    </script>
